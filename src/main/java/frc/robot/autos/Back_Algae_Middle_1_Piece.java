...
public class Back_Algae_Middle_1_Piece extends SequentialCommandGroup {
    public Back_Algae_Middle_1_Piece(CoralScorer coralScorer, AlgaeIntake_Wrist algaeIntake_Wrist, AlgaeIntake algaeIntake, Arm arm, Wrist wrist, Intake intake){
        ...
        AutoPath C_B =  AutoPath.PP("C_B");
        AutoPath B_C=  AutoPath.PP("B_C");


    
        addCommands(
            C_B.resetOdometryToStart(),
            C_B.follow(),
            B_C .follow(),
            C_R0.follow(),

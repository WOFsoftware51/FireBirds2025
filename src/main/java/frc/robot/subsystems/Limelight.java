...
public class Limelight {
  ...
  public void periodic() {
    ...
    if(getBestTarget()==6){
        Global_Variables.yawTarget = -60;
    }
    else if(getBestTarget()==7){
        Global_Variables.yawTarget = 0;
    }
    else if(getBestTarget()==8){
        Global_Variables.yawTarget = 60;
    }
    else if(getBestTarget()==9){
        Global_Variables.yawTarget = 120;
    }
    else if(getBestTarget()==10){
        Global_Variables.yawTarget = 180;
    }
    else if(getBestTarget()==11){
        Global_Variables.yawTarget = -120;
    }
    else if(getBestTarget()==17){
        Global_Variables.yawTarget = 60;
    }
    else if(getBestTarget()==18){
        Global_Variables.yawTarget = 0;
    }
    else if(getBestTarget()==19){
        Global_Variables.yawTarget = -60;
    }
    else if(getBestTarget()==20){
        Global_Variables.yawTarget = -120;
    }
    else if(getBestTarget()==21){
        Global_Variables.yawTarget = 180;
    }
    else if(getBestTarget()==22){
        Global_Variables.yawTarget = -120;
    }
    else {
        Global_Variables.yawTarget = 180;
